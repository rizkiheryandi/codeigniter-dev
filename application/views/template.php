...
<html>
    <head>
        ...
        <title>Urang Awak Hotel | Dashboard</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>" class="logo">
                    ...
                    <span class="logo-mini"><b>UA</b>H</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>URANG AWAK</b></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url()?>template/dist/img/profil.jpg" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Rizki Heryandi</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo base_url()?>template/dist/img/profil.jpg" class="img-circle" alt="User Image">
                                        <p>
                                            Rizki - Senior Web Developer
                                            <small>Developing since Nov. 2012</small>
                                        </p>
                                    </li>
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; 2017 <a href="http://urang-awak-hotel.dev">PT Urang Awak Resort</a>.</strong> All rights reserved.
            </footer>

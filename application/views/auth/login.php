...
<html>
    <head>
        ...
        <title>Urang Awak Hotel | Login</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>"><b>UA HOTEL</b> LOGIN</a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <button type="submit" name="submit" class="btn btn-alert btn-block btn-flat"><i class="fa fa-sign-in"></i> LOGIN</button>
                    </div><!-- /.col -->
